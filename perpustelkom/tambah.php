...
<body>
    ...
    <h1 class="logo2">Tambah data sepatu</h1>
    <button class="btn"><a href="index.php" class="col0"><h3>home data</h3></a></button>
    <form action="" method="post" enctype="multipart/form-data" class="tabah">
        <div class="HDR">
            <table class="HDR">
                <tr>
                    <td><label for="nama">NAMA : </label></td>
                    <td><input type="text" name="nama" id="nama" class="input1" ></td>
                </tr>
                <tr>
                    <td><label for="nrp">NRP : </label></td>
                    <td><input type="text" name="nrp" id="nrp" class="input1" ></td>
                </tr>
                <tr>
                    <td><label for="harga">HARGA : </label></td>
                    <td><input type="text" name="harga" id="harga" class="input1" ></td>
                </tr>
                <tr>
                    <td><label for="gmail">GMAIL : </label></td>
                    <td><input type="text" name="gmail" id="gmail" class="input1" ></td>
                </tr>
                <tr>
                    <td><label for="merek">MEREK : </label></td>
                    <td><input type="text" name="merek" id="merek" class="input1" ></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><button type="submit" name="submit" class="bttn ">Tambah Data!</button></td>
                </tr>
